...
exec unos_skola('Medicinska skola','Nikifora Maksimovica 6','Cacak','0652123698','medicinskacacak@gmail.com');
...
exec unos_odeljenje(1,'Akuser',1);
exec unos_odeljenje(1,'Farmaceutski tehnicar',1);
...
exec unos_ucenik('Nevena','Zecevic',to_date('16/03/2001','dd/mm/yyyy'),'Z','Mrcajevci bb', 'Cacak','0625487944','nevena@gmail.com',1);
exec unos_ucenik('Jovana','Zivkovic',to_date('11/06/2001','dd/mm/yyyy'),'Z','Mrcajevci bb', 'Cacak','0612358974','jocka@gmail.com',1);
exec unos_ucenik('Nevefeqena','rgeerht',to_date('26/03/2001','dd/mm/yyyy'),'Z','Gornja Gorevnica bb', 'Cacak','0663256987','nevgergeena@gmail.com',2);
exec unos_ucenik('Jovfewgwrana','Zivkowrgwrgvic',to_date('01/06/2001','dd/mm/yyyy'),'Z','Prijevor bb', 'Cacak','0625478912','jockbrtrnba@gmail.com',2);
...
exec unos_ucionica(1,'Hemikalije',45);

insert into cas select * from ekonomska.cas;

exec unos_prisustvo(5,3,'N');
exec unos_prisustvo(6,4,'N');
exec unos_prisustvo(7,8,'N');
exec unos_prisustvo(8,8,'N');

insert into prisustvo select * from gimnazija.prisustvo;

insert into ocena select * from gimnazija.ocena;

exec unos_cas(1,3,2,5,sysdate);
exec unos_cas(6,5,2,7,sysdate);